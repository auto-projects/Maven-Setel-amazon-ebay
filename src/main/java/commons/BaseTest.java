...
public class BaseTest {
    ...
    private String getUrlPage(String urlPage) {
        String url = null;
        if (urlPage.equals("AMAZON")) {
            url = GlobalConstants.AMAZON_PAGE_URL;
        } else if (urlPage.equals("EBAY")) {
            url = GlobalConstants.EBAY_PAGE_URL;
        } else {
            throw new RuntimeException("Please input correct the URL name");
        }
        return url;
    }
    ...
    protected WebDriver getBrowserDriver(String browserName, String appUrl) {
        ...
        driver.manage().timeouts().implicitlyWait(GlobalConstants.LONG_TIMEOUT, TimeUnit.SECONDS);
        if (appUrl.equals("AMAZON")) {
            driver.get(GlobalConstants.AMAZON_PAGE_URL);
        } else if (appUrl.equals("EBAY")) {
